...
public class OnHeapSingleTreeBuilderTests extends OpenSearchTestCase {
    ...
    public void test_sortAndAggregateSegmentStarTreeDocuments() throws IOException {
        ...
        Iterator<StarTreeDocument> starTreeDocumentIterator = builder.sortAndAggregateSegmentStarTreeDocuments(starTreeDocuments);
