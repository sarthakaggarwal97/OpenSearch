...
public class Lucene95CustomStoredFieldsFormat extends StoredFieldsFormat {
    ...
    public static final CompressionMode BEST_COMPRESSION_MODE =
        new FilterCompressionMode(new DeflateWithPresetDictCompressionMode());
    public static final CompressionMode BEST_SPEED_MODE = new FilterCompressionMode(new LZ4WithPresetDictCompressionMode());
    ...
    public Lucene95CustomStoredFieldsFormat(Lucene95CustomCodec.Mode mode, int compressionLevel) {
        ...
        zstdCompressionMode = new FilterCompressionMode(new ZstdCompressionMode(compressionLevel));
        zstdNoDictCompressionMode = new FilterCompressionMode(new ZstdNoDictCompressionMode(compressionLevel));
    }
