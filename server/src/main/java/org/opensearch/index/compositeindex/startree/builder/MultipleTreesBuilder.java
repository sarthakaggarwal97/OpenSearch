...
public class MultipleTreesBuilder implements Closeable {
    ...
    private final StarTreeFieldSpec.StarTreeBuildMode _buildMode;
    ...
    public void build() throws Exception {
        ...
        LOGGER.info("Starting building {} star-trees with configs: {} using {} builder", numStarTrees, compositeFieldConfigs, _buildMode);
